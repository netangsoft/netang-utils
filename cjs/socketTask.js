...
const $n_findIndex = require('lodash/findIndex')
const $n_isNil = require('lodash/isNil')
const $n_isFunction = require('lodash/isFunction')

const $n_isValidObject = require('@netang/utils/isValidObject')
const $n_getThrowMessage = require('@netang/utils/getThrowMessage')
const $n_isJson = require('@netang/utils/isJson')
const $n_json = require('@netang/utils/json')
const $n_numberDeep = require('@netang/utils/numberDeep')
const $n_success = require('@netang/utils/success')
const $n_fail = require('@netang/utils/fail')
const $n_runAsync = require('@netang/utils/runAsync')
const $n_run = require('@netang/utils/run')

/**
 * socket 任务
 */
function socketTask(options) {
